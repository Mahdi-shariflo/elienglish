...
import { initialDataGroupProperties, initialDataProperties } from '@/lib/table-column';
...
const Page = () => {
  ...
  const { data, isPending, isSuccess, isFetching, isLoading } = useGetGroupProperties({
    page: filter.page,
  ...
  return (
    <div>
      ...
      <ReactTable
        ...
        mainData={product?.propertiesGroups}
        showData={columns}
        columns={['_id', 'title', 'archive', 'action']}
