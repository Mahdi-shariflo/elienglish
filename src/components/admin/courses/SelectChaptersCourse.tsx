            ...
            title={
              <div className="flex items-center justify-between">
                <div className="!space-y-4">
                  ...
                  <p className="font-medium text-[#8E98A8]">فصل {product?.lessons}</p>
                </div>
                <div className="flex h-[50px] items-center gap-4 rounded-lg !bg-[#E5EAEF] px-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{product?.episodes?.length} درس</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{product?.duration} دقیقه</span>
                  </div>
                </div>
              </div>
            }
