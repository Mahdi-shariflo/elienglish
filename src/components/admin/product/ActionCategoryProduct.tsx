...
const ActionCategoryProduct = ({ modal, setModal }: Props) => {
  const {
  ...
  const { mutate, isPending, isSuccess, reset } = ActionCategoryProductAdmin();
...
export default ActionCategoryProduct;
