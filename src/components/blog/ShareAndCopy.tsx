      ...
      <div className="mt-[24px] flex h-[88px] items-center justify-between gap-3 rounded-[16px] border-t-[1px] border-[#E5EAEF] bg-[#F4F6FA] px-[24px]">
        ...
        <Button onClick={() => setShow(true)} className="w-fit min-w-fit">
          ...
          <span>
            ...
            >
              <path
                d="M13.5 14.7246C14.0741 14.2952 14.5491 13.7473 14.8929 13.1181C15.2367 12.4889 15.4411 11.7931 15.4923 11.078C15.5435 10.3628 15.4403 9.64502 15.1897 8.97326C14.9392 8.30151 14.547 7.69149 14.04 7.18461L11.04 4.18461C10.097 3.27382 8.83394 2.76985 7.52296 2.78124C6.21198 2.79263 4.95791 3.31848 4.03087 4.24552C3.10383 5.17256 2.57799 6.42662 2.5666 7.7376C2.5552 9.04859 3.05918 10.3116 3.96997 11.2546L5.67997 12.9746"
                stroke="#6E3DFF"
                stroke-width="2"
              ...
              />
              <path
                d="M11.5012 10.7244C10.9271 11.1539 10.452 11.7018 10.1083 12.331C9.7645 12.9602 9.56009 13.6559 9.50887 14.3711C9.45765 15.0862 9.56083 15.804 9.81142 16.4758C10.062 17.1475 10.4541 17.7575 10.9612 18.2644L13.9612 21.2644C14.9042 22.1752 16.1672 22.6792 17.4782 22.6678C18.7892 22.6564 20.0433 22.1305 20.9703 21.2035C21.8973 20.2765 22.4232 19.0224 22.4346 17.7114C22.446 16.4004 21.942 15.1374 21.0312 14.1944L19.3212 12.4844"
                stroke="#6E3DFF"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
      ...
      <BaseDialog isOpen={show} title="اشتراک‌گذاری" size="md" onClose={() => setShow(false)}>
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="mt-[20px] font-medium text-[16px] text-[#0C0C0C]">
            این بلاگ را با دوستان خود به اشتراک بگذارید!
          </p>
