      ...
      <div className="flex w-full items-center gap-3 lg:hidden">
        <Button onClick={() => setModalFilter(true)} className="relative z-10 w-full border">
          <span>
            ...
            >
              <path
                d="M18.332 6.04297H13.332C12.9904 6.04297 12.707 5.75964 12.707 5.41797C12.707 5.0763 12.9904 4.79297 13.332 4.79297H18.332C18.6737 4.79297 18.957 5.0763 18.957 5.41797C18.957 5.75964 18.6737 6.04297 18.332 6.04297Z"
                fill="#172334"
              />
              <path
                d="M5.0013 6.04297H1.66797C1.3263 6.04297 1.04297 5.75964 1.04297 5.41797C1.04297 5.0763 1.3263 4.79297 1.66797 4.79297H5.0013C5.34297 4.79297 5.6263 5.0763 5.6263 5.41797C5.6263 5.75964 5.34297 6.04297 5.0013 6.04297Z"
                fill="#172334"
              />
              <path
                d="M8.33464 8.95833C6.38464 8.95833 4.79297 7.36667 4.79297 5.41667C4.79297 3.46667 6.38464 1.875 8.33464 1.875C10.2846 1.875 11.8763 3.46667 11.8763 5.41667C11.8763 7.36667 10.2846 8.95833 8.33464 8.95833ZM8.33464 3.125C7.06797 3.125 6.04297 4.15 6.04297 5.41667C6.04297 6.68333 7.06797 7.70833 8.33464 7.70833C9.6013 7.70833 10.6263 6.68333 10.6263 5.41667C10.6263 4.15 9.6013 3.125 8.33464 3.125Z"
                fill="#172334"
              />
              <path
                d="M18.3333 15.207H15C14.6583 15.207 14.375 14.9237 14.375 14.582C14.375 14.2404 14.6583 13.957 15 13.957H18.3333C18.675 13.957 18.9583 14.2404 18.9583 14.582C18.9583 14.9237 18.675 15.207 18.3333 15.207Z"
                fill="#172334"
              />
              <path
                d="M6.66797 15.207H1.66797C1.3263 15.207 1.04297 14.9237 1.04297 14.582C1.04297 14.2404 1.3263 13.957 1.66797 13.957H6.66797C7.00964 13.957 7.29297 14.2404 7.29297 14.582C7.29297 14.9237 7.00964 15.207 6.66797 15.207Z"
                fill="#172334"
              />
              <path
