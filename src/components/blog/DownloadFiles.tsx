  ...
  return (
    <>
      <div className="mt-[24px]">
        {blog?.requiredLogin && !user?.accessToken ? (
          <div className="flex h-[88px] items-center gap-3 rounded-[16px] border-[3px] border-[#E0D7FB] bg-[#EDE8FC] px-[24px] dark:border-none dark:bg-[#070118]">
            ...
            <p className="flex flex-wrap items-center gap-2 font-medium dark:text-white lg:gap-0">
              ...
              <Link href={'/auth/'} className="text-[14px] text-main underline lg:text-[16px]">
                وارد حساب کاربری
              </Link>
              <span className="text-[14px] lg:text-[16px]">خود شوید یا</span>
              <Link href={'/auth/'} className="text-[14px] text-main underline lg:text-[16px]">
                ثبت نام
              </Link>
