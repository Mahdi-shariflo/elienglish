...
const Section3 = () => {
  return (
    <div className="flex h-[385px] items-center justify-center bg-[#F4F6FA]">
      <div className="container_page flex items-center justify-between gap-10">
        <Link
          href={'#'}
          className="flex w-full cursor-pointer flex-col rounded-xl border border-[#E5EAEF] bg-white p-4 transition-all duration-400 hover:border-main hover:bg-transparent"
        >
          <p className="font-bold text-[20px]">آزمون مقدماتی تعیین سطح</p>
          <div className="mt-3 flex items-center justify-between">
            <p className="font-medium text-[16px] text-main">تعیین سطح</p>
          ...
          <div className="mt-2 flex h-[35px] w-[185px] items-center justify-center gap-2 self-end rounded-lg bg-main font-medium text-white">
            <span className="text-[14px]">شروع تعین سطح</span>
            <span>
              <svg
                width="24"
                height="24"
