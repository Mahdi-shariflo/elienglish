...
const AddCartSingleProduct = ({ className, product, showDetail }: Props) => {
  return (
    <>
      <div
        className={`drop_shadow_cart bottom-0 left-0 z-10 flex w-full flex-col rounded-lg border border-gray-100 lg:!z-0 lg:w-[288px] lg:min-w-[288px] lg:gap-3 lg:!border-gray-50 ${className}`}
      >
        <div className="bg-white lg:rounded-lg lg:p-2">
          <AddtiveProduct />
          {showDetail && (
            <div className="hidden items-center gap-3 border-b border-[#E4E7E9] pb-2 lg:flex">
              <Image
          ...
          <div className="mt-2 flex w-full flex-row-reverse items-center justify-between border-[#F4F6FA] px-[20px] !pt-4 lg:mt-5 lg:flex-col lg:border-t lg:px-0">
            {/* discount */}
    ...
    <div className="bg-[#EDE8FC] px-2 pt-2 lg:bg-transparent lg:p-0">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <p className="font-medium text-[#172334]">سفارش سازی محصول</p>
        </div>
        <span>
          <svg
            width="20"
      ...
      <div className="mt-4 flex flex-col gap-4 border-[#F4F6FA] px-4 pt-4 lg:border-t">
        <div className="flex items-center justify-between border-dashed pb-3 lg:border-b">
