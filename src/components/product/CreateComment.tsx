...
const CreateComment = ({ product, modal, setModal, showCommentRate }: Props) => {
  ...
  return (
    <div>
      {showCommentRate && (
        <div className="flex flex-col items-center justify-between rounded-xl p-4 shadow-comment lg:flex-row">
      ...
      >
        <div>
          {product && (
            <div className="flex items-center gap-2 rounded-lg border border-gray-100 p-3 shadow-comment">
              <Image
