...
const MoreInformationCourse = ({ course }: { course: Course }) => {
  ...
  return (
    <div className="mt-10 rounded-lg !border-gray-100 bg-white dark:!border-[#263248] dark:bg-[#0B1524] lg:mt-4 lg:border lg:p-8">
                  ...
                  .map((item, idx) => (
                    <AccordionItem
                      ...
                      classNames={{
                        content: '!px-5',
                        trigger: 'demo_style',
                        heading: ' border border-gray-100 dark:border-[#263248] !rounded-lg !px-2',
                      }}
                      title={
                    ...
                    <AccordionItem
                      ...
                      title={
                        <div className="flex items-center justify-between">
                          ...
                          <div className="hidden h-[44px] items-center gap-4 rounded-lg !bg-[#F4F6FA] px-4 dark:!bg-[#172334] lg:flex">
                            <div className="flex items-center gap-2">
                              <span>
                                <svg
                                  width="24"
                              ...
                              <span className="font-regular text-[#6A7890]">
                                {' '}
                          ...
                          return (
                            <div className="flex items-center justify-between" key={idx}>
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium text-[14px] text-main lg:text-[16px]">
                                  {item.title}
                                </span>
                              </div>
                              <div className="flex h-[44px] items-center gap-4 rounded-lg px-4">
                                <Link
                                  className="mt-1 flex h-[30px] w-fit min-w-fit items-center justify-center !rounded-lg bg-[#EDE8FC] !px-4 !font-medium text-[12px] text-main"
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="font-regular text-[#6A7890] dark:text-[#8E98A8]">
                                    {' '}
                                    درس {idx + 1}
                                  </span>
                                </div>
