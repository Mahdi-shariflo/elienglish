...
const MoreInformationCourse = ({ course }: { course: Course }) => {
  ...
  return (
    <div className="mt-10">
      ...
      >
        {course?.description ? (
          <Tab key={'interdauce'} title={<p>معرفی </p>}>
            ...
            {/* <AccordinMoreInformation course={course} handleTabChange={handleTabChange} /> */}
          </Tab>
        ) : null}
        {/* <Tab key={"use"} title={"نحوه استفاده"}>
                        <AccordinMoreInformation course={course} selectedTab={selectedTab} handleTabChange={handleTabChange} />
                    </Tab> */}
        <Tab key={'information'} title={<p>دموی رایگان</p>}>
          <div className="mt-5">
            <Title title="دموی رایگان" />
            <Accordion className="!mt-10" itemClasses={{ base: '!mt-5' }}>
                ...
                <AccordionItem
                  ...
                  title={
                    <p className="font-medium text-[18px]">
                      <span className="text-[18px] text-main">{item?.order}. </span>
                      {item?.title}
                    </p>
                  }
                >
        ...
        <Tab key={'chapters'} title={<p>برنامه آموزشی</p>}>
          <div className="mt-5">
            <Title title="برنامه آموزشی" />
            <Accordion className="!mt-10" itemClasses={{ base: '!mt-5' }}>
                  ...
                  title={
                    <div className="flex items-center justify-between">
                      <div className="!space-y-4">
                        ...
                        <p className="font-medium text-[#8E98A8]">فصل {item.lessons}</p>
                      </div>
                      <div className="flex h-[50px] items-center gap-4 rounded-lg !bg-[#E5EAEF] px-4">
                        <div className="flex items-center gap-2">
                          <span>
                            <svg
                              width="24"
                      ...
                      return (
                        <div className="flex items-center justify-between" key={idx}>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-extrabold text-[16px] text-main">
                              {item.title}
                            </span>
                          </div>
        ...
        <Tab key={'comments'} title={<p>دیدگاه‌ها</p>}>
          <Comments
            commentInfo={{
              _id: course._id,
