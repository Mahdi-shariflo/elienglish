...
function refreshFeatures() {
  ...
  if (document.getElementById('calt'))
    codeCSS3 += !document.getElementById('calt').checked ? '"calt" off, ' : '"calt" on, ';
  if (document.getElementById('rvrn'))
    codeCSS3 += !document.getElementById('rvrn').checked ? '"rvrn" off, ' : '"rvrn" on, ';

  if (document.getElementById('dlig'))
    codeCSS3 += !document.getElementById('dlig').checked ? '' : '"dlig", ';
  if (document.getElementById('hlig'))
    codeCSS3 += !document.getElementById('hlig').checked ? '' : '"hlig", ';

  if (document.getElementById('swsh'))
  ...
  if (document.getElementById('ss01'))
    codeCSS3 += !document.getElementById('ss01').checked ? '' : '"ss01", ';
  if (document.getElementById('ss02'))
    codeCSS3 += !document.getElementById('ss02').checked ? '' : '"ss02", ';
  if (document.getElementById('ss03'))
    codeCSS3 += !document.getElementById('ss03').checked ? '' : '"ss03", ';
  if (document.getElementById('ss04'))
    codeCSS3 += !document.getElementById('ss04').checked ? '' : '"ss04", ';
  if (document.getElementById('ss05'))
    codeCSS3 += !document.getElementById('ss05').checked ? '' : '"ss05", ';
  if (document.getElementById('ss06'))
    codeCSS3 += !document.getElementById('ss06').checked ? '' : '"ss06", ';
  if (document.getElementById('ss07'))
    codeCSS3 += !document.getElementById('ss07').checked ? '' : '"ss07", ';
  if (document.getElementById('ss08'))
    codeCSS3 += !document.getElementById('ss08').checked ? '' : '"ss08", ';
  if (document.getElementById('ss09'))
    codeCSS3 += !document.getElementById('ss09').checked ? '' : '"ss09", ';
  if (document.getElementById('ss10'))
    codeCSS3 += !document.getElementById('ss10').checked ? '' : '"ss10", ';
  if (document.getElementById('ss11'))
    codeCSS3 += !document.getElementById('ss11').checked ? '' : '"ss11", ';
  if (document.getElementById('ss12'))
    codeCSS3 += !document.getElementById('ss12').checked ? '' : '"ss12", ';
  if (document.getElementById('ss13'))
    codeCSS3 += !document.getElementById('ss13').checked ? '' : '"ss13", ';
  if (document.getElementById('ss14'))
    codeCSS3 += !document.getElementById('ss14').checked ? '' : '"ss14", ';
  if (document.getElementById('ss15'))
    codeCSS3 += !document.getElementById('ss15').checked ? '' : '"ss15", ';
  if (document.getElementById('ss16'))
    codeCSS3 += !document.getElementById('ss16').checked ? '' : '"ss16", ';
  if (document.getElementById('ss17'))
    codeCSS3 += !document.getElementById('ss17').checked ? '' : '"ss17", ';
  if (document.getElementById('ss18'))
    codeCSS3 += !document.getElementById('ss18').checked ? '' : '"ss18", ';
  if (document.getElementById('ss19'))
    codeCSS3 += !document.getElementById('ss19').checked ? '' : '"ss19", ';
  if (document.getElementById('ss20'))
    codeCSS3 += !document.getElementById('ss20').checked ? '' : '"ss20", ';

  if (document.getElementById('smcp'))
    codeCSS3 += !document.getElementById('smcp').checked ? '' : '"smcp", ';
  if (document.getElementById('c2sc'))
    codeCSS3 += !document.getElementById('c2sc').checked ? '' : '"c2sc", ';

  if (document.getElementById('ordn'))
    codeCSS3 += !document.getElementById('ordn').checked ? '' : '"ordn", ';

  if (document.getElementById('lnum'))
  ...
  if (document.getElementById('tnum'))
